...
const AcceptTask = ({ navigation }: INavigation) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ width: dimensions.width * 0.9, marginVertical: 8 }}>
                ...
                }}>Task yang Diambil</Text>
            </View>
            <FlatList
                data={Tasks}
                renderItem={({ item }) => (
                    <CardItems.AcceptTask acceptTask={item} action={() => navigation.navigate("WorkerDetailTask")}></CardItems.AcceptTask>
                )}
